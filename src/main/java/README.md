...
You can test all APIs using the Postman collection located in `postman-collection/LocalConnect.postman_collection.json`. Import into Postman to access all endpoints and sample requests.
